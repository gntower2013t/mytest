...
digraph DataFlow {
    ...
    wc [label="Store"];
    id [label="SearchConfigService"];
    lr [label="Component \n(search-toolbar)"];

    wc -> id [label="selector"];
    id -> lr [label="filters$:Observable"];

    id -> wc [label="Action (load config)", constraint=false]
...
* The same config set loaded by SearchConfigService  
```json
"columns": [
{
  "head": "Patient",
